      ...
      <div className="relative z-10 max-w-md md:max-w-6xl mx-auto">
        <div className="hidden md:flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-[11px] font-bold tracking-[0.25em] uppercase text-white/40 mt-1">
              Manage & track attendee list
            </p>
          </div>
          <div
            className="px-4 py-2 rounded-full border text-[10px] font-black tracking-widest uppercase"
            style={{ borderColor: lime, color: lime, boxShadow: `0 0 12px ${lime}55` }}
          >
              ...
              {currentItems.map((user) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className="w-14 h-14 md:w-16 md:h-16 rounded-xl md:rounded-2xl border-2 overflow-hidden bg-zinc-900 relative shrink-0"
                      style={{ borderColor: lime }}
                    >
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1 mt-1">
                        ...
                        />
                        <span className="text-[8px] md:text-[9px] font-bold uppercase opacity-60">
        ...
        {selectedUser && (
          <>
            ...
            <motion.div
              ...
              className="hidden md:block fixed inset-0 z-40 bg-black/70 backdrop-blur-sm"
            />
            ...
            >
              <div
                ...
                style={{ backgroundImage: "url('/img/bg-texture.jpeg')", backgroundSize: 'cover', opacity: 0.3 }}
              />
              ...
              <div className="relative z-10 w-full flex flex-col h-full">
                <div className="w-full flex justify-between items-center mb-6">
                  ...
                  <button
                    onClick={() => setSelectedUser(null)}
                    className="w-9 h-9 rounded-full border flex items-center justify-center hover:shadow-[0_0_12px_rgba(163,255,18,0.5)] transition-shadow"
                    style={{ borderColor: lime }}
                  >
                ...
                <div className="flex flex-col items-center mb-8">
                  <div
                    ...
                    style={{ borderColor: lime, boxShadow: `0 0 25px ${lime}` }}
                  >
                ...
                <div className="space-y-4">
                  <div
                    className="px-6 py-4 rounded-2xl border-2 bg-black/60 flex justify-between items-center"
                    style={{ borderColor: lime }}
                  >
            ...
            <motion.div
              ...
              className="md:hidden fixed inset-0 z-50 bg-black p-8 flex flex-col items-center"
            >
              <div
                className="absolute inset-0 z-0"
